...
497 commands, 1001 phrases, 39 sources.
...
| canonical id | phrases | args | risk | undo | whole | description | source |
|---|---|---|---|---|---|---|---|
| `core_utils.check_for_updates` | `check for update`, `check for updates`, `update samsara` | - | write | no |  | Checks GitHub for a newer version of Samsara. | `plugins/commands/core_utils.py:101` |
| `core_utils.reload_config` | `refresh config`, `reload config`, `reload configuration`, `reread config` | - | ui | yes |  | Re-reads your settings from disk without restarting. | `plugins/commands/core_utils.py:119` |
| `core_utils.reset_hints` | `replay hints`, `reset hints`, `show hints again` | - | write | no |  | Clears the hints you have already seen so they can appear again. | `plugins/commands/core_utils.py:160` |
| `core_utils.restart_samsara` | `reboot samsara`, `restart`, `restart samsara` | - | destructive | no |  | Closes Samsara and starts it again. | `plugins/commands/core_utils.py:65` |
| `core_utils.what_can_i_say` | `help`, `what are my commands`, `what can i say`, `what commands do i have` | - | read | yes |  | Reads out the commands that work in the app you are using. | `plugins/commands/core_utils.py:142` |

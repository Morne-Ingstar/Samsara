...
· [Try the beta](https://github.com/Morne-Ingstar/Samsara/releases/tag/v0.30.0-beta.2)
...
| [**v0.30.0-beta.2 — tester build**](https://github.com/Morne-Ingstar/Samsara/releases/tag/v0.30.0-beta.2) | Try newer hands-free and command workflows and report rough edges. |
